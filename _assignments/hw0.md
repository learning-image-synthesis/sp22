...
4. File Transfer.  Unzip your website and copy the folder to your project directory: `cp -r projX/ /afs/andrew.cmu.edu/course/16/726-sp22/www/projects/andrew_id/projX`.
   The folder structure should look like this:
    ```angular2html
    # suppose you are at /afs/andrew.cmu.edu/course/16/726-sp22/www/projects/andrew_id/
    index.html
    proj1/
        index.html
        data/...
    proj2/
        ...
        data/...
    ```
5. Publish. The course website needs to be refreshed with your updated files. Do that by going [here](https://www.andrew.cmu.edu/server/publish.html), choosing web pages for a course, and inputing 16-726-sp22.
6. Last step, test your page by visiting: `http://www.andrew.cmu.edu/course/16-726-sp22/projects/andrew_id/projX/`.
`

__FAQs__
- Remember __NOT to use any absolute links__ to images etc, as these will not work online. __Only use relative links.__\
- Note that 16, 726-sp22 is connected by `-` in URL while your folder is `16/726-sp22/`     
