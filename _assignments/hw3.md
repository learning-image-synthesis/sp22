...
In both parts, you will gain experience implementing GANs by writing code for the generator, discriminator, and training loop, for each model. Code and data can be found [here](../static_files/assignments/hw3/16726_s22_hw3.zip).
...
### Implement Data Augmentation [5 points]
...
### Differentiable Augmentation [5 points]
...
### CycleGAN Training Loop [10 points]
...
* Train your GAN to generate higher-resolution images **(up to 2 pts)** They are available at [this link](https://www.andrew.cmu.edu/course/16-726-sp22/projects/handouts/proj3/high_res_images.zip).
